...
class RandomForestClassifier:
    ...
    def fit(self, X, y):
        ...
        for tree_index in range(self.n_estimators):
            ...
            tree_modified = self.modify_tree_for_random_forest(tree, max_features_count, total_features)
    ...
    def modify_tree_for_random_forest(self, tree, max_features_count, total_features):
        ...
        def modified_find_best_split(feature_data, target_labels, total_features_param):
            ...
            for feature_index in selected_features:
                ...
                for threshold in unique_thresholds:
                    information_gain = tree.calculate_information_gain(target_labels, feature_values, threshold)
